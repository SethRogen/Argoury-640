...
public class Player extends Entity implements PlayerType, Destroyable {
    ...
    private SkillDialogue skillDialogue;
    private int maxSkillDialogueAmount, selectedSkillDialogueAmount;
    ...
    public void openSkillDialogue(SkillDialogue skillDialogue, int maxAmount, int... items) {
        ...
        Static.proto.sendString(this, 916, 1, skillDialogue.info);
        Static.proto.sendInterfaceVariable(this, 754, skillDialogue.configId);
        Static.proto.sendInterfaceVariable(this, 8094, maxAmount);
        Static.proto.sendInterfaceVariable(this, 8095, selectedSkillDialogueAmount);
        for(int i = 0; i < SkillDialogue.CHILDREN.length; i++) {
            ...
            //Static.proto.sendSpecialString(this, children[1], ItemInfo.get(itemId).name);
        }
        
        //Hiding 'All' and 'Custom' cause can't unlock buttons for some reason
       //PacketSender.sendInterfaceConfig(this, 905, 5, true);
        Static.proto.sendInterface(this, 916, 905, 4, true);//Amount Interface ID
        
        //PacketSender.sendChatBoxInterface(this, 905);
        Static.proto.sendInterface(this, 905, 752, 13, true); //ChatBox Interface ID
        
        //PacketSender.sendInterface(this, 916, 905, 4, 1);
        Static.proto.sendInterface(this, 916, 905, 4, true);//Amount Interface ID
    ...
    public void skillDialogueSelect(int slot) {
        if(skillDialogue == null) {
            //if(chatBoxInterfaceId != -1)
              //  PacketSender.removeChatBoxInterface(this);
            return;
        }
