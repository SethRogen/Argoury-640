...
import com.runescape.logic.utility.DoubleNodeRunnable;
...
public class PlaneObjectHandler implements ActionHandler, ObjectOptionHandler {
    ...
    public void load(ActionHandlerSystem system) throws Exception {
        BufferedReader cfg = new BufferedReader(new FileReader(Static.parseString("%WORK_DIR%/planeobjects.ini")));
        int lineNumber = 0;
        String line;
