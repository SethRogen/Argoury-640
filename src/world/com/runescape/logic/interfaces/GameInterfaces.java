package com.runescape.logic.interfaces;
...
public class GameInterfaces {
	...
	public GameInterface NULL_SCREEN = new GameInterface(56);
	public GameInterface GRAPHIC_OPTIONS = new GameInterface(742);
	public GameInterface AUDIO_OPTIONS = new GameInterface(743);
    ...
    public static final GameInterface BANK_SCREEN = new GameInterface(762, null, new NodeRunnable<Player>() {
        ...
        public void run(Player player) {
            ...
            Static.proto.sendString(player, 762, 45, "Bank of " + Constants.GAME_NAME);
