...
public class BankWithdrawXInput implements PlayerInput {
    ...
    public void handle(Player player, Object input) {
        ...
        if (input instanceof Integer) {
            ...
            int index = player.getAttributes().getInt("withdrawXIndex");
            BankManager.withdrawItem(player, index, amount);
            player.getAttributes().set("withdrawX", amount);
        }
    }
}
