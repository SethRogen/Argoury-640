...
import com.runescape.adapter.protocol.update.NPCUpdateAdapter;
import com.runescape.adapter.protocol.update.PlayerUpdaterAdapter;
import com.runescape.content.combat.Magic;
import com.runescape.content.combat.Ranged;
import com.runescape.content.magictemp.MagicTemp;
import com.runescape.content.skills.summoning.SummoningPouch;
import com.runescape.engine.login.LoginResponse;
import com.runescape.engine.misc.LocalPlayerListSynchronizer;
import com.runescape.engine.tick.Tick;
import com.runescape.link.WCSInitiator;
...
import com.runescape.logic.item.GroundItemManager;
import com.runescape.logic.item.ItemDefinition;
import com.runescape.logic.item.ItemXMLDefinition;
import com.runescape.logic.map.PathFinder;
import com.runescape.logic.map.PathProcessor;
import com.runescape.logic.map.PathRequest;
...
import com.runescape.logic.npc.NPCXMLDefinition;
import com.runescape.logic.npc.misc.FishingSpotNPC;
import com.runescape.logic.object.DoorManager;
import com.runescape.logic.object.GameObject;
import com.runescape.logic.object.ObjectManager;
import com.runescape.logic.player.Player;
import com.runescape.logic.player.PlayerType;
import com.runescape.logic.player.RemotePlayer;
import com.runescape.logic.utility.EntityUpdater;
...
public final class World implements Runnable {
    ...
    private void loadNPCsAndCorrespondingRegions() {
        ...
        try (FileReader reader = new FileReader(Static.parseString("%WORK_DIR%/world/npcs/spawns/npcspawns.json"))) {
            List<NPCSpawn> spawns = gson.fromJson(reader, new TypeToken<List<NPCSpawn>>(){}.getType());
