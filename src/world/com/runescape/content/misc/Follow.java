...
public class Follow extends Tick {
    ...
    public boolean execute() {
        ...
        Tile newDest = other.getPathProcessor().getHistory()[1];//1
        ...
        if (origDest.equals(newDest) || (calcDest && origDest.distance(newDest) == 1)) {//1
        ...
        if (!other.getPathProcessor().isHooked(entity)) {
            if (entity instanceof Player) {
                ...
                if (interval() != 2)// this was set to 3 before
                    setInterval(2);
            }
        } else {
            if (interval() != 0)
