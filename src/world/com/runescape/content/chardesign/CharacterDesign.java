...
import com.runescape.content.chardesign.DefaultDesign.DefaultSubDesign;
import com.runescape.content.handler.ActionHandlerSystem;
import com.runescape.content.handler.ButtonHandler;
import com.runescape.content.tutorial.Tutorial;
    ...
    public void handleButton(Player player, int opcode, int interfaceId, int b,
        ...
        switch (b) {
            ...
            case 120:
                ...
                Static.proto.sendConfig(player, 1016, index);
