...
public class CombatUtilities {
    ...
    public static class SpecialEnergy {
        ...
        public void update() {
            Static.proto.sendVarp(player, 300, getConfigAmount());
        }
    ...
    public static boolean clippedProjectile(Entity entity, Entity victim) {
        ...
        while (currentTile != end) {            
            ...
            if (currentTile.clipProjectileMovment(localDirection, 1, false, true) && nextTile.clipProjectileMovment(localDirectionInverse, 1, false, true)) {
