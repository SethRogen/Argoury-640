...
public class Ranged {
	...
	public static final void load() throws IOException {
		...
		try {
			bows = (Map<Integer, BowDefinition>) Static.xml.readObject(Static.parseString("%WORK_DIR%/world/items/combat/bows.xml"));
			projectiles = (Map<Integer, AmmunitionDefinition>) Static.xml.readObject(Static.parseString("%WORK_DIR%/world/items/combat/ammunitions.xml"));
