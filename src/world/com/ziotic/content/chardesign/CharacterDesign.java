package com.ziotic.content.chardesign;
...
import com.ziotic.content.chardesign.DefaultDesign.DefaultSubDesign;
import com.ziotic.content.handler.ActionHandlerSystem;
import com.ziotic.content.handler.ButtonHandler;
import com.ziotic.content.tutorial.Tutorial;
import com.ziotic.logic.player.Appearance;
 ...
 * @author Maxime
 */
public class CharacterDesign implements ButtonHandler {
    ...
    public void load(ActionHandlerSystem system) throws Exception {
        system.registerButtonHandler(new int[]{1028}, this);
    }
    ...
    public void handleButton(Player player, int opcode, int interfaceId, int b,
        ...
        switch (b) {
            ...
            case 120:
                ...
                Static.proto.sendVarp(player, 1016, index);
    ...
    public static void randomizeLook(Player player, Appearance app) {
        ...
        Static.proto.sendInterfaceVariable(player, 1008, hairIndex);
        Static.proto.sendInterfaceVariable(player, 1009, facialIndex);
        Static.proto.sendInterfaceVariable(player, 1010, torsoIndex);
        Static.proto.sendInterfaceVariable(player, 1013, legIndex);
        Static.proto.sendInterfaceVariable(player, 1014, feetIndex);
        Static.proto.sendInterfaceVariable(player, 1015, app.getColor(0));
        Static.proto.sendInterfaceVariable(player, 1016, app.getColor(1));
        Static.proto.sendInterfaceVariable(player, 1017, app.getColor(2));
        Static.proto.sendInterfaceVariable(player, 1018, app.getColor(3));
        Static.proto.sendInterfaceVariable(player, 1019, app.getColor(4));
    }
