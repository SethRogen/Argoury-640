...
import com.ziotic.content.skill.ProducingTick;
 ...
 */
public class CookingManager extends ProducingTick  {
	...
	public boolean isSuccessfull() {
		for (CookingRecipe recipe : CookingRecipe.values()) {
		int success = SkillManager.interpolate(recipe.getLowRoll(), recipe.getHighRoll(), player.getLevels().COOKING);
