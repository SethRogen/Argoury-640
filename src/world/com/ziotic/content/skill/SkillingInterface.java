...
public class SkillingInterface implements ButtonHandler {
    ...
    public static void Open(Player player, int option, String ChooseString, int[] items, int maxQuantity, String ItemName, ItemNameFilter filter) { 
	...
	case 905:
		switch(b) {
		 default:
             logger.debug("[SKill Interface] Unhandled button [interface=" + interfaceId + ", button=" + b + ", button2=" + b2 + ", button3=" + b3 + ", opcode=" + opcode + "]");
             break;
		}
		break;
		case 916: 
