...
public class LobbyServer implements Application {
    ...
    public void main(String[] args) throws Throwable {
        ...
        Static.serverCache.load(new File(Static.parseString(Constants.WORK_DIR + "/servercache")));
        ...
        Static.rs2Cache.load(new File(Static.parseString(Constants.WORK_DIR + "/rs2cache")));
