...
public abstract class Familiar extends NPC {
	...
	public void subPreProcess() {
		...
		if (currentTimeLeft != timeLeft) {
			Static.proto.sendVarp(owner, 1176, timeLeft);
	...
	public void summon(SummoningPouch pouch) {
		...
		// send packet's first
		Static.proto.sendVarp(owner, 448, pouch.getPouchId());
		Static.proto.sendVarp(owner, 1174, pouch.getNPCId());
		Static.proto.sendVarp(owner, 1175, specialCost() << 23);
		Static.proto.sendVarp(owner, 1176, 768);
		Static.proto.sendVarp(owner, 1160, 243269632);
	...
	public void dismiss() {
		if (owner.getFamiliar() != null) {
			...
			Static.proto.sendVarp(owner, 448, -1);
			Static.proto.sendVarp(owner, 1174, -1);
			Static.proto.sendVarp(owner, 1175, 182986);
			Static.proto.sendVarp(owner, 1176, 0);
			Static.proto.sendVarp(owner, 1160, -1);
	...
	public void incrementSpecialPoints(int specialPoints) {
		...
		Static.proto.sendVarp(owner, 1177, this.specialPoints);
	}
