...
import com.ziotic.logic.object.DoorManager.DoorDefinition.SpecificDoorDefinition;
...
public class DoorManager implements ObjectOptionHandler {
    ...
    public void load() {
        try {
            ...
            BufferedReader cfg = new BufferedReader(new FileReader(Static.parseString(Constants.WORK_DIR + "/world/map/doors.ini")));
            int lineNumber = 0;
            String line;
