...
import com.ziotic.content.chardesign.CharacterDesign;
import com.ziotic.content.combat.misc.SkullRegisterManager;
import com.ziotic.content.grotto.War;
import com.ziotic.content.misc.LevelNormalize;
import com.ziotic.content.misc.LevelRestore;
import com.ziotic.content.misc.RunEnergyRestore;
import com.ziotic.content.prayer.PlayerPrayerManager;
import com.ziotic.content.prayer.PrayerManager;
import com.ziotic.content.prayer.PrayerManager.Book;
import com.ziotic.content.shop.Shop;
...
import com.ziotic.logic.item.AppearanceListener;
import com.ziotic.logic.item.BankContainer;
import com.ziotic.logic.item.ConsumablesHandler;
import com.ziotic.logic.item.EquipmentDefinition;
import com.ziotic.logic.item.EquipmentListener;
...
public class Player extends Entity implements PlayerType, Destroyable {
    ...
    public void onChangedHP() {
        if (!isOnLogin()) {
            Static.proto.sendVarp(this, 1240, getHP() * 2);
        }
    }
    ...
    public void updateXPCounter() {
        Static.proto.sendVarp(this, 1801, (int) (levels.getXPGained() * 10));
    }
