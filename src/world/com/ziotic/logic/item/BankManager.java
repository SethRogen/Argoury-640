...
public class BankManager implements ActionHandler, ButtonHandler, ItemSwitchHandler, ObjectOptionHandler, NPCOptionHandler {
    ...
    public static void updateTabs(Player player) {
        ...
        Static.proto.sendVarp(player, 1246, bank.getTabSize(1) + (bank.getTabSize(2) * 1024) + (bank.getTabSize(3) * 1048576));
        Static.proto.sendVarp(player, 1247, bank.getTabSize(4) + (bank.getTabSize(5) * 1024) + (bank.getTabSize(6) * 1048576));
        Static.proto.sendVarp(player, 1248, bank.getTabSize(7) + (bank.getTabSize(8) * 1024) - 2013265920);
    }
