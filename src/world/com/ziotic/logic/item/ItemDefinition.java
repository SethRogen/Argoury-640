...
public class ItemDefinition {
        ...
        synchronized (cachedDefinitions) {
            ...
            if (def == null) {
                ...
                if (def != null) {
                    ...
                    System.out.println("ITEM LEND DEF: " + def.lendedParentId2);
                    System.out.println("ITEM LEND DEF2:" + def.lendedParentId);
    ...
    public static void loadEquipmentIds() {
        try {
            try {
                equipmentIds = Static.xml.readObject(Static.parseString(Constants.WORK_DIR + "/world/items/equipids.xml"));
            } catch (IOException e) {
                ...
                Static.xml.writeObject(equipmentIds, Static.parseString(Constants.WORK_DIR + "/world/items/equipids.xml"));
            }
    ...
    public void copyDefinition(ItemDefinition def1, ItemDefinition def2) {
        ...
        lendedParentId = def2.lendedParentId;
        lendedParentId2 = def2.lendedParentId2;
    ...
    public int getLendId() {
        return lendedParentId;
    }
    public int getLendTemplateId() {
        return lendedParentId2;
    }
