...
//                                }
    ...
    public static void load() throws IOException {
        ...
        try {
             ...
             */
            potions = (Map<String, Potion>) Static.xml.readObject(Static.parseString(Constants.WORK_DIR + "/world/items/food/potiondefs.xml"));
            foods = (Map<String, EatableFood>) Static.xml.readObject(Static.parseString(Constants.WORK_DIR + "/world/items/food/food.xml"));
