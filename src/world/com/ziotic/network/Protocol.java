...
public interface Protocol {
    ...
    public Protocol sendAccessMask(Player player, int range1, int range2, int interfaceId1, int childId1, int interfaceId2, int childId2); //sendIComponentSettings
    ...
    public Protocol sendVarp(Player player, int id, int val); //sendVar in matrix
    ...
    public Protocol sendInterfaceVariable(Player player, int id, int val); //sendGlobalConfig in matrix
    ...
    public Protocol sendInterfaceConfig(Player player, int interfaceId, int value); //VarBit in matrix 
    ...
    public Protocol sendGrandExchangeOffer(Player player, GrandExchangeOffer offer);
