...
public class GameServer implements Application {
    ...
    public void main(String[] args) throws Throwable {
        ...
        Static.serverCache.load(new File(Static.parseString(Constants.WORK_DIR + "/cache/servercache")));
        ...
        Static.rs2Cache.load(new File(Static.parseString(Constants.WORK_DIR + "/cache/rs2cache")));
