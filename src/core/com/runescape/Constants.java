...
public class Constants {
    ...
    public static final String CONFIGURATION_FILE = DATA_FOLDER +"/world/runescape.ini";
    public static final String MAP_XTEA_FILE = DATA_FOLDER + "/world/map/mapxtea.dat";
    public static final String MAP_XTEA_DIR = DATA_FOLDER + "/world/map/mapxtea/";
