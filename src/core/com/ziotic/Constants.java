...
public class Constants {
    ...
    public static final String SERVER_NAME = "Runescape"; //to implement this into game 
    public static final String WORK_DIR = "./data";
    ...
    public static final String MAP_XTEA_FILE = WORK_DIR + "/world/map/mapxtea.dat";
    public static final String MAP_XTEA_DIR = WORK_DIR + "/world/map/mapxtea/";
