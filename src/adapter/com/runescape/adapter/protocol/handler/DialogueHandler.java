        ...
        case 905: 
            if (buttonId == 6)  {
                if (player.itemSelection != null) {
                    player.itemSelection.customAmount(player);
                }
            } else if (buttonId >= 14 && buttonId <= 27) {
                if (player.itemSelection != null) {
                    player.itemSelection.selected(player, buttonId - 14);
                } else {
                    player.skillDialogueSelect(buttonId - 14);
                }
            }
        	break;
        default:
