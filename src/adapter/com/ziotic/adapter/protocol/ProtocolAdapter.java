...
import com.ziotic.content.grandexchange.GrandExchangeOffer;
...
public final class ProtocolAdapter implements Protocol {
        ...
        for (String friendObj : friends) {
            ...
            if (friend != null) {
                ...
                if (friend.inLobby()) {
                    ...
                    sb.append("Runescape ").append(' '); //change this to server name if you wish
                }
    ...
    @Override
    public Protocol sendVarp(Player player, int id, int val) {
        FrameBuilder fb;
    ...
    /*
     *         if (Class348_Sub3.aClass114_6584 == Class348_Sub45.aClass114_7105) { //634
        ...
        if (Class51.currentIncommingOpcode == OutgoingOpcode.aIncommingOpcode_1916) { //640
    ...
    @Override
    public Protocol sendGrandExchangeOffer(Player player, GrandExchangeOffer offer) { //Packet 97, 20
        FrameBuilder fb = new FrameBuilder(97, 20);
        fb.writeByte(0);
        fb.writeByte(0);
        player.getSession().write(fb.toFrame());
        return this;
    ...
    /**
     *         if (Class348_Sub40_Sub24.aClass114_9324 == Class348_Sub3.aClass114_6584) { //85, 4
            int i = Class299.aClass348_Sub49_Sub2_3813.read128Byte((byte) -104);
            int i_194_ = Class299.aClass348_Sub49_Sub2_3813.read128Byte((byte) -92);
            int i_195_ = Class299.aClass348_Sub49_Sub2_3813.readShortLE128(-127);
     ...
     */
   // @Override
	//public Protocol sendMusic(int id, int delay, int volume) { //10, 4 or 51, 4 or 0, 4 or 84, 4
    	//FrameBuilder fb = new FrameBuilder(88, 4);
		//stream.write128Byte(delay);
		//tream.write128Byte(volume);
